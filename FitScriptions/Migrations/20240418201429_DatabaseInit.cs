        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BarcodeUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxAllowedTrainingSessions = table.Column<int>(type: "int", nullable: false),
                    MaxAllowedDailyTrainingSessions = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionTypes", x => x.SubscriptionTypeId);
                    table.ForeignKey(
                        name: "FK_SubscriptionTypes_Gyms_GymId",
                        column: x => x.GymId,
                        principalTable: "Gyms",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BarcodeUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TrainingSessionsDone = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GymEntranceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    GymId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserSubscriptionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GymEntrances", x => x.GymEntranceId);
                    table.ForeignKey(
                        name: "FK_GymEntrances_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GymEntrances_Gyms_GymId",
                        column: x => x.GymId,
                        principalTable: "Gyms",
                        principalColumn: "GymId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GymEntrances_UserSubscriptions_UserSubscriptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GymEntrances_GymId",
                table: "GymEntrances",
                column: "GymId");

            migrationBuilder.CreateIndex(
                name: "IX_GymEntrances_UserId",
                table: "GymEntrances",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_GymEntrances_UserSubscriptionId",
                table: "GymEntrances",
                column: "UserSubscriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionTypes_GymId",
